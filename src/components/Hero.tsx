      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center text-white z-20">
          ...
          >
            ...
            >
              If you are an <span className="font-bold text-pink-300">experienced software developer</span> with excellent
              <span className="font-bold text-pink-300"> English communication skills</span>, we would like to invest in you!
            </motion.p>
            <motion.div
